...
//            myEnvelope2.tick( ENVTICKRATEMS );
        ...
        draw.line_segment(lastXY2[0],lastXY2[1],origin[0] + msTicks/10,origin[1]-myFlashDialog.red);
        lastXY2[0] = origin[0] + msTicks/10;
        lastXY2[1] = ((int)origin[1]-myFlashDialog.red);
//
//
//        draw.pen_color(0,0,0);
...
//
        ...
        draw.line_segment(Box2lastXY2[0],Box2lastXY2[1],Box2origin[0] + msTicks/10,Box2origin[1]-myDownBeat.green);
        Box2lastXY2[0] = Box2origin[0] + msTicks/10;
        Box2lastXY2[1] = ((int)Box2origin[1]-myDownBeat.green);
//
//
//        draw.pen_color(0,0,0);
